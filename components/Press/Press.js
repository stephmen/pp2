  ...
  return (
    <StyledPress>
      ...
      <div className="container">
        ...
        <Disque>
        <p className="c1">
          <span className="sous-titre">Extraits de presse... La Pourpour</span>
        </p>
        <p className="c1">
          <span className="c0">
        ...
        <p className="c1">
          <span className="sous-titre">
            Extraits de presse&hellip; Danse des Breloques
          </span>
        </p>
        <p className="c1">
          <span className="c0">
        ...
        <p className="c1">
          <span className="sous-titre">
            Extraits de presse&hellip; Karusell Musik
          </span>
        </p>
        <p className="c1">
          <span className="c0">
        ...
        <p className="c1">
          <span className="sous-titre">Extraits de presse... Le Bal</span>
        </p>
        <p className="c1">
          <span className="c0">
        ...
        <p className="c1">
          <span className="sous-titre">
            Extraits de presse&hellip;Tout le monde
          </span>
        </p>
        <p className="c1">
          <span className="c0">
        ...
        <p className="c1">
          <span className="c0">
            &ldquo;So enthralled was the audience they even managed to coax a
            few reserved Upper-Canadian couples onto the floor to waltz.
            Magnifique!&rdquo;
          </span>
        </p>
        <p className="c1">
